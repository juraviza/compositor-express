...
const DEFAULT_PRODUCT_MEMORY = {
  ...
  'barriles': 'Bebidas alcohólicas',
  'barril': 'Bebidas alcohólicas',
  'parriles': 'Bebidas alcohólicas',
  'parril': 'Bebidas alcohólicas',
...
const KEYWORDS = [
  ...
  { category: 'Bebidas alcohólicas', terms: ['absolut', 'smirnoff', 'ciroc', 'cîroc', 'bailes', 'baileys', 'tequila', 'jager', 'jäger', 'maria brizard', 'maría brizar', 'anis del mono', 'anís del mono', 'anis dulce', 'anís dulce', 'martin miller', 'licor 43', 'vodca', 'vodka', 'licor', 'barril', 'barriles', 'parril', 'parriles'] },
  { category: 'Refrescos', terms: ['coca cola', 'cocacola', 'fanta', 'sprite', 'tonica', 'tónica', 'limonada', 'neste', 'nestea', 'aquarios', 'aquarius', 'kas', 'zero'] },
  { category: 'Cervezas', terms: ['cruzcampo', 'heineken', 'heniker', 'radler', 'aguila', 'águila', 'estrella', 'victoria', 'mahou', 'amstel', 'alhambra', 'san miguel', 'cerveza'] },
